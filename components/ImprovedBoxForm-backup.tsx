            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div className="space-y-8">
                ...
                <div>
                  ...
                  {items.length > 0 ? (
                    <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-4 mb-4 max-h-80 overflow-y-auto">
            ...
            <div className="space-y-4 pt-4">
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <button
                  type="button"
                  onClick={() => router.push('/')}
                  className="sm:w-auto px-8 py-4 border border-gray-300 dark:border-gray-600 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 font-medium transition-colors"
                >
                  Abbrechen
                </button>
              </div>
